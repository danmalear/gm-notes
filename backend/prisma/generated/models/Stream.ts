...
export type StreamWhereInput = {
  ...
  StreamId?: Prisma.UuidFilter<"Stream"> | string
  Type?: Prisma.StringFilter<"Stream"> | string
  Version?: Prisma.IntFilter<"Stream"> | number
...
export type StreamScalarWhereWithAggregatesInput = {
  ...
  StreamId?: Prisma.UuidWithAggregatesFilter<"Stream"> | string
  Type?: Prisma.StringWithAggregatesFilter<"Stream"> | string
  Version?: Prisma.IntWithAggregatesFilter<"Stream"> | number
...
export type StreamOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"StreamId" | "Type" | "Version" | "CreatedAt" | "UpdatedAt", ExtArgs["result"]["stream"]>
...
export interface StreamDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Streams and only return the `StreamId`
   * const streamWithStreamIdOnly = await prisma.stream.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Streams and only return the `StreamId`
   * const streamWithStreamIdOnly = await prisma.stream.updateManyAndReturn({
   *   select: { StreamId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface StreamFieldRefs {
  ...
  readonly Type: Prisma.FieldRef<"Stream", 'String'>
  readonly Version: Prisma.FieldRef<"Stream", 'Int'>
